@echo off
:: ======================================================
:: OpenVoice + Whisper Installation Script for Windows
:: ======================================================
...
echo.
echo === OpenVoice + Whisper Setup Script ===
echo.
...
echo [1/13] Creating virtual environment...
uv venv --python=3.10
if errorlevel 1 (
...
hf download myshell-ai/OpenVoice --local-dir model

:: 8. Apply patch (if exists)
